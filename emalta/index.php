...
$resultvideo = mysqli_query($link, "SELECT * FROM video ORDER BY views DESC LIMIT 10");
...
echo "<h1> > Vídeos mais acessados </h1>
    ...
    while ($video = mysqli_fetch_assoc($resultvideo))
    {
            echo "<div class=\"video\">
                ...
                <img src=\"../assets/imagens/animes_thumbs/" . $aux["id_fk"] . "/miniaturas" . "/" . $video["numep"] . ".jpg" . "\" alt=\"Thumbnail\" />
